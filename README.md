...
- **10x faster** than Express and traditional WebSocket libraries
...
### HTTP Features
- **High Performance** - 10x faster than Express for HTTP requests → [Server Documentation](./docs/http/Server.md)
...
- **Middleware Support** - Guards, Pipes, Filters, and Interceptors for WebSocket handlers → [WebSocket Middleware](./docs/websocket/Middleware.md)
...
- **HTTP**: 10x faster than Express
- **WebSocket**: 10x faster than Socket.IO
