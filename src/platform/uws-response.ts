...
export class UwsResponse extends Writable {
  ...
  /**
   * Set cookie (Express-compatible alias)
   *
   * Supports maxAge in milliseconds and automatic conversion to expires date.
   * Handles signed cookies when options.signed is true and options.secret is provided.
   *
